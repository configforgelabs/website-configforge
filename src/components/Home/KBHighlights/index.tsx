            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 dark:bg-primary/20 text-primary text-sm font-medium mb-4">
                        ...
                        <Translate id="kb.kicker">Knowledge Base Highlights</Translate>
                    </div>
                    <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                        <Translate id="kb.title">Knowledge Base</Translate>
                    </h2>
                    <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                        <Translate id="kb.desc">My living library of step-by-step guides. I focus on architecture, implementations, and migrations across Microsoft 365, Azure, and hybrid environments.</Translate>
                    </p>
                </div>
                    ...
                    {highlights.map((highlight, index) => (
                        ...
                        >
                            ...
                            <div className="flex items-start gap-4 mb-6">
                                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/10 to-primary/20 dark:from-primary/20 dark:to-primary/30 text-primary dark:text-primary flex items-center justify-center flex-shrink-0 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg shadow-primary/20">
                                    {highlight.icon}
                                </div>
                                <div>
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700/50">
                                <div className="flex items-center text-primary font-semibold text-sm group-hover:gap-3 gap-2 transition-all">
                                    <span><Translate id="kb.explore">Explore Articles</Translate></span>
                ...
                <div className="text-center bg-gradient-to-br from-white to-primary/5 dark:from-gray-800 dark:to-primary/10 rounded-2xl p-12 border border-gray-200/50 dark:border-gray-700/50 shadow-xl shadow-primary/5 dark:shadow-primary/10">
                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        <Translate id="kb.cta.title">Browse Complete Knowledge Base</Translate>
                    </h3>
                    <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
                        <Translate id="kb.cta.desc">Access our full library of step-by-step guides, templates, and best practices. Everything you need for successful Microsoft 365 and Azure implementations.</Translate>
                    </p>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-6">
                        <Translate id="kb.cta.stat">130+ comprehensive articles and growing</Translate>
                    </p>
                </div>
